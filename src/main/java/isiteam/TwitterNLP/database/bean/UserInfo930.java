...
/**
 * UserInfo930 entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "user_info_9_30", catalog = "twittercrawler", uniqueConstraints = @UniqueConstraint(columnNames = {
		"userId", "crawledNum" }))
public class UserInfo930 implements java.io.Serializable {
	...
	/** full constructor */
	public UserInfo930(String userId, String screenName, String name,
