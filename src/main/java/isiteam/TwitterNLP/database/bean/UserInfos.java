...
/**
 * UserInfos entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "user_infos", catalog = "twittercrawler", uniqueConstraints = @UniqueConstraint(columnNames = {
		"userId", "crawledNum" }))
public class UserInfos implements java.io.Serializable {
	...
	/** full constructor */
	public UserInfos(String userId, String screenName, String name,
